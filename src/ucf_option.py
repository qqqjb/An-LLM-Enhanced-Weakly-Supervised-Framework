...
parser = argparse.ArgumentParser(description='SCL-CLIP')
...
parser.add_argument('--model-path', default='model/model_ucf-vit32.pth')
...
parser.add_argument('--lr', default=10e-5)
